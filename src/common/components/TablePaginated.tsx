...
export const TablePaginated = forwardRef((props: TablePaginatedProps, ref) => {
  ...
  const getData = async () => {
    ...
    try {
      ...
      const validPageSize = [5, 10, 25, 50].includes(response.resultByPage) ? response.resultByPage : response.pageSize;
