import { Autocomplete, Backdrop, Box, Button, Card, CircularProgress, Divider, Grid, IconButton, MenuItem, Stack, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TextField, Tooltip, Typography, createFilterOptions } from '@mui/material';
...
import { IArticle, IWarehouseData, MerchandiseEntry } from '../../../types/types';
import { addMerchandiseEntry, addNewArticle, getExistingArticles, getWarehouseById } from '../../../api/api.routes';
...
*/
export const PackageModal = (props: { setOpen: Function; refetch: Function }) => {
    ...
    useEffect(() => {
        const fetch = async () => {
            ...
            try {
                const warehouse = await getWarehouseById('fc6d0fdd-8cfa-49a7-863e-206a7542a5e5');
    ...
    const onSubmit: SubmitHandler<MerchandiseEntry> = async (data) => {
        try {
            ...
            const object = {
                ...
                Id_AlmacenDestino: 'fc6d0fdd-8cfa-49a7-863e-206a7542a5e5',
