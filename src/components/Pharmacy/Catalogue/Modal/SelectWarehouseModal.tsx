                ...
                >
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      props.setOpen(false)
                      setWarehouseId(warehouseSelected?.id ?? warehouseIdSeted);
                      fetchData(false, warehouseSelected?.id ?? warehouseIdSeted);
                      if(warehouseSelected && warehouseSelected?.esSubAlmacen){
                        ...
                        fetchWareHouseMovements( warehouseSelected.id ?? warehouseIdSeted);
                      }
                      else{
                        setPrincipalWarehouseId(warehouseSelected?.id ?? warehouseIdSeted);
                      }
