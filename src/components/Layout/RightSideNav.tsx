...
const messagesByLink: { [key: string]: any } = {
  ...
  '/compras/solicitud-compras/productos-stock-bajo': <MensajeProdcutosStockBajo />,
  '/compras/solicitud-compras/productos-solicitados-orden-compra': <MensajeProductosSolicitados />,
  '/compras/solicitud-compras/productos-espera-autorizacion': <MensajeProductosEspera />,
...
const RightSideNav: React.FC<RightSideNavProps> = ({ open, onClose, currentPage }) => {
