...
//   const { enabled, setEnabled, setSearch } = useExistingArticlePagination((state) => ({
...
//             }}
//           >
//             <SearchBar title="Busca el articulo existente..." searchState={setSearch} sx={{ width: '30%' }} />
//             <Divider sx={{ my: 1 }} />
...
//               >
//                 {enabled ? 'Mostrar artículos existentes deshabilitados' : 'Mostrar artículos existentes habilitados'}
//               </Button>
//               <Button
