...
// export const WarehouseView = lazy(() => import('../features/warehouse/views/Warehouse')); // Comentada por estar pendiente
...
export const PackageBuildingView = lazy(() => import('../views/Nursing/PackageBuildingView'));
...
export const TreasuryAdministrationSafeBoxView = lazy(
  () => import('@/features/treasury/administration/screens/TreasuryAdministrationSafeBox')
);
