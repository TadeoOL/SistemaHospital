...
import { getInvoicePatientBillPagination } from '../../services/invoice/invoicePatientBill';
...
export const useInvoicePatientBillPaginationStore = create<State & Action>((set, get) => ({
  ...initialValues,
  ...
  fetchData: async () => {
    ...
    try {
      const res = await getInvoicePatientBillPagination(
