...
import { InvoiceSellInvoicePagination } from '../../types/invoiceTypes';
import { getPharmacySellInvoicesPagination } from '../../services/invoice/invoicePatientBill';
...
export const useInvoicePharmacySellsBillPaginationStore = create<State & Action>((set, get) => ({
  ...initialValues,
  ...
  fetchData: async () => {
    ...
    try {
      const res = await getPharmacySellInvoicesPagination(
