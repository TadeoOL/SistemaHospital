...
import { getBiomedicalEquipmentPagination } from '../../services/hospitalization/biomedicalEquipmentService';
...
export const useBiomedicalEquipmentPaginationStore = create<State & Action>((set, get) => ({
  ...initialValues,
  ...
  fetchData: async () => {
    ...
    try {
      const res = await getBiomedicalEquipmentPagination(
