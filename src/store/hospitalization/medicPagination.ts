...
import { getMedicPagination } from '../../services/hospitalization/medicService';
...
export const useMedicPaginationStore = create<State & Action>((set, get) => ({
  ...initialValues,
  ...
  fetchData: async () => {
    ...
    try {
      const res = await getMedicPagination(
