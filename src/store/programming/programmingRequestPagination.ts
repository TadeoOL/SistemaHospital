...
import { getProgrammingRequestsPagination } from '../../services/programming/programmingRequest';
...
export const useProgrammingRequestPaginationStore = create<State & Action>((set, get) => ({
  ...initialValues,
  ...
  fetchData: async () => {
    ...
    try {
      const res = await getProgrammingRequestsPagination(
