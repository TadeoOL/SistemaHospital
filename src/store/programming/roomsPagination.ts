...
import { getRoomsPagination } from '../../services/programming/roomsService';
...
export const useRoomsPaginationStore = create<State & Action>((set, get) => ({
  ...initialValues,
  ...
  fetchData: async () => {
    ...
    try {
      const res = await getRoomsPagination(
