...
import { getAllSellsHistory } from '../../../services/pharmacy/pointOfSaleService';
...
export const useSellsHistoryPaginationStore = create<State & Action>((set, get) => ({
  ...initialValues,
  ...
  fetchData: async () => {
    ...
    try {
      const res = await getAllSellsHistory(
